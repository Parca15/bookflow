...
public interface ClientService {
    ...
    ClientResponse findById(Long companyId, Long id);
    ClientResponse findByDocument(Long companyId, String documentNumber);
    List<ClientResponse> findAll();
    List<ClientResponse> findAllByCompany(Long companyId);
    Page<ClientResponse> findAllByCompanyPaged(Long companyId, Pageable pageable);
    List<ClientResponse> findAllCompanies();
    ClientResponse update(Long companyId, Long id, UpdateClientRequest request);
    void delete(Long companyId, Long id);
    void activate(Long companyId, Long id);
    void deletePermanently(Long companyId, Long id);
}
